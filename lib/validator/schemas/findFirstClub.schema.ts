...
export const ClubFindFirstSelectSchema: z.ZodType<Prisma.ClubSelect> = z.object({
...
export const ClubFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    collegeId: z.boolean().optional(),
    description: z.boolean().optional(),
...
export const ClubFindFirstSchema: z.ZodType<Prisma.ClubFindFirstArgs> = z.object({ select: ClubFindFirstSelectSchema.optional(), include: z.lazy(() => ClubIncludeObjectSchema.optional()), orderBy: z.union([ClubOrderByWithRelationInputObjectSchema, ClubOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClubWhereInputObjectSchema.optional(), cursor: ClubWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClubScalarFieldEnumSchema, ClubScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ClubFindFirstArgs>;

export const ClubFindFirstZodSchema = z.object({ select: ClubFindFirstSelectSchema.optional(), include: z.lazy(() => ClubIncludeObjectSchema.optional()), orderBy: z.union([ClubOrderByWithRelationInputObjectSchema, ClubOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClubWhereInputObjectSchema.optional(), cursor: ClubWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClubScalarFieldEnumSchema, ClubScalarFieldEnumSchema.array()]).optional() }).strict();