...
export const CollegeFindFirstSelectSchema: z.ZodType<Prisma.CollegeSelect> = z.object({
...
export const CollegeFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    city: z.boolean().optional(),
    state: z.boolean().optional(),
...
export const CollegeFindFirstSchema: z.ZodType<Prisma.CollegeFindFirstArgs> = z.object({ select: CollegeFindFirstSelectSchema.optional(), include: z.lazy(() => CollegeIncludeObjectSchema.optional()), orderBy: z.union([CollegeOrderByWithRelationInputObjectSchema, CollegeOrderByWithRelationInputObjectSchema.array()]).optional(), where: CollegeWhereInputObjectSchema.optional(), cursor: CollegeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CollegeScalarFieldEnumSchema, CollegeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CollegeFindFirstArgs>;

export const CollegeFindFirstZodSchema = z.object({ select: CollegeFindFirstSelectSchema.optional(), include: z.lazy(() => CollegeIncludeObjectSchema.optional()), orderBy: z.union([CollegeOrderByWithRelationInputObjectSchema, CollegeOrderByWithRelationInputObjectSchema.array()]).optional(), where: CollegeWhereInputObjectSchema.optional(), cursor: CollegeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CollegeScalarFieldEnumSchema, CollegeScalarFieldEnumSchema.array()]).optional() }).strict();