...
export const CollegeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CollegeSelect> = z.object({
...
export const CollegeFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    city: z.boolean().optional(),
    state: z.boolean().optional(),
...
export const CollegeFindFirstOrThrowSchema: z.ZodType<Prisma.CollegeFindFirstOrThrowArgs> = z.object({ select: CollegeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CollegeIncludeObjectSchema.optional()), orderBy: z.union([CollegeOrderByWithRelationInputObjectSchema, CollegeOrderByWithRelationInputObjectSchema.array()]).optional(), where: CollegeWhereInputObjectSchema.optional(), cursor: CollegeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CollegeScalarFieldEnumSchema, CollegeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CollegeFindFirstOrThrowArgs>;

export const CollegeFindFirstOrThrowZodSchema = z.object({ select: CollegeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CollegeIncludeObjectSchema.optional()), orderBy: z.union([CollegeOrderByWithRelationInputObjectSchema, CollegeOrderByWithRelationInputObjectSchema.array()]).optional(), where: CollegeWhereInputObjectSchema.optional(), cursor: CollegeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CollegeScalarFieldEnumSchema, CollegeScalarFieldEnumSchema.array()]).optional() }).strict();