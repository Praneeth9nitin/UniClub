...
export const RegistrationsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.RegistrationsSelect> = z.object({
...
export const RegistrationsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    studentId: z.boolean().optional(),
    eventId: z.boolean().optional(),
    createdAt: z.boolean().optional(),
...
export const RegistrationsFindFirstOrThrowSchema: z.ZodType<Prisma.RegistrationsFindFirstOrThrowArgs> = z.object({ select: RegistrationsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RegistrationsIncludeObjectSchema.optional()), orderBy: z.union([RegistrationsOrderByWithRelationInputObjectSchema, RegistrationsOrderByWithRelationInputObjectSchema.array()]).optional(), where: RegistrationsWhereInputObjectSchema.optional(), cursor: RegistrationsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RegistrationsScalarFieldEnumSchema, RegistrationsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RegistrationsFindFirstOrThrowArgs>;

export const RegistrationsFindFirstOrThrowZodSchema = z.object({ select: RegistrationsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RegistrationsIncludeObjectSchema.optional()), orderBy: z.union([RegistrationsOrderByWithRelationInputObjectSchema, RegistrationsOrderByWithRelationInputObjectSchema.array()]).optional(), where: RegistrationsWhereInputObjectSchema.optional(), cursor: RegistrationsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RegistrationsScalarFieldEnumSchema, RegistrationsScalarFieldEnumSchema.array()]).optional() }).strict();