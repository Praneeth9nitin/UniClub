...
export const RoleInClubFindFirstOrThrowSelectSchema: z.ZodType<Prisma.RoleInClubSelect> = z.object({
...
export const RoleInClubFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    clubId: z.boolean().optional(),
    club: z.boolean().optional(),
...
export const RoleInClubFindFirstOrThrowSchema: z.ZodType<Prisma.RoleInClubFindFirstOrThrowArgs> = z.object({ select: RoleInClubFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RoleInClubIncludeObjectSchema.optional()), orderBy: z.union([RoleInClubOrderByWithRelationInputObjectSchema, RoleInClubOrderByWithRelationInputObjectSchema.array()]).optional(), where: RoleInClubWhereInputObjectSchema.optional(), cursor: RoleInClubWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RoleInClubScalarFieldEnumSchema, RoleInClubScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RoleInClubFindFirstOrThrowArgs>;

export const RoleInClubFindFirstOrThrowZodSchema = z.object({ select: RoleInClubFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RoleInClubIncludeObjectSchema.optional()), orderBy: z.union([RoleInClubOrderByWithRelationInputObjectSchema, RoleInClubOrderByWithRelationInputObjectSchema.array()]).optional(), where: RoleInClubWhereInputObjectSchema.optional(), cursor: RoleInClubWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RoleInClubScalarFieldEnumSchema, RoleInClubScalarFieldEnumSchema.array()]).optional() }).strict();