...
export const StudentInClubFindFirstOrThrowSelectSchema: z.ZodType<Prisma.StudentInClubSelect> = z.object({
...
export const StudentInClubFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    clubId: z.boolean().optional(),
    studentId: z.boolean().optional(),
    roleId: z.boolean().optional(),
...
export const StudentInClubFindFirstOrThrowSchema: z.ZodType<Prisma.StudentInClubFindFirstOrThrowArgs> = z.object({ select: StudentInClubFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => StudentInClubIncludeObjectSchema.optional()), orderBy: z.union([StudentInClubOrderByWithRelationInputObjectSchema, StudentInClubOrderByWithRelationInputObjectSchema.array()]).optional(), where: StudentInClubWhereInputObjectSchema.optional(), cursor: StudentInClubWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StudentInClubScalarFieldEnumSchema, StudentInClubScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StudentInClubFindFirstOrThrowArgs>;

export const StudentInClubFindFirstOrThrowZodSchema = z.object({ select: StudentInClubFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => StudentInClubIncludeObjectSchema.optional()), orderBy: z.union([StudentInClubOrderByWithRelationInputObjectSchema, StudentInClubOrderByWithRelationInputObjectSchema.array()]).optional(), where: StudentInClubWhereInputObjectSchema.optional(), cursor: StudentInClubWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StudentInClubScalarFieldEnumSchema, StudentInClubScalarFieldEnumSchema.array()]).optional() }).strict();