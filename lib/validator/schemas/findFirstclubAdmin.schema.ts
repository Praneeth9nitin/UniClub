...
export const clubAdminFindFirstSelectSchema: z.ZodType<Prisma.clubAdminSelect> = z.object({
...
export const clubAdminFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    firstName: z.boolean().optional(),
    lastName: z.boolean().optional(),
    email: z.boolean().optional(),
...
export const clubAdminFindFirstSchema: z.ZodType<Prisma.clubAdminFindFirstArgs> = z.object({ select: clubAdminFindFirstSelectSchema.optional(), include: z.lazy(() => clubAdminIncludeObjectSchema.optional()), orderBy: z.union([clubAdminOrderByWithRelationInputObjectSchema, clubAdminOrderByWithRelationInputObjectSchema.array()]).optional(), where: clubAdminWhereInputObjectSchema.optional(), cursor: clubAdminWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClubAdminScalarFieldEnumSchema, ClubAdminScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.clubAdminFindFirstArgs>;

export const clubAdminFindFirstZodSchema = z.object({ select: clubAdminFindFirstSelectSchema.optional(), include: z.lazy(() => clubAdminIncludeObjectSchema.optional()), orderBy: z.union([clubAdminOrderByWithRelationInputObjectSchema, clubAdminOrderByWithRelationInputObjectSchema.array()]).optional(), where: clubAdminWhereInputObjectSchema.optional(), cursor: clubAdminWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClubAdminScalarFieldEnumSchema, ClubAdminScalarFieldEnumSchema.array()]).optional() }).strict();