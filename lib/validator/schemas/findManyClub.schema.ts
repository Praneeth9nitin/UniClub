...
export const ClubFindManySelectSchema: z.ZodType<Prisma.ClubSelect> = z.object({
...
export const ClubFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    collegeId: z.boolean().optional(),
    description: z.boolean().optional(),
...
export const ClubFindManySchema: z.ZodType<Prisma.ClubFindManyArgs> = z.object({ select: ClubFindManySelectSchema.optional(), include: z.lazy(() => ClubIncludeObjectSchema.optional()), orderBy: z.union([ClubOrderByWithRelationInputObjectSchema, ClubOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClubWhereInputObjectSchema.optional(), cursor: ClubWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClubScalarFieldEnumSchema, ClubScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ClubFindManyArgs>;

export const ClubFindManyZodSchema = z.object({ select: ClubFindManySelectSchema.optional(), include: z.lazy(() => ClubIncludeObjectSchema.optional()), orderBy: z.union([ClubOrderByWithRelationInputObjectSchema, ClubOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClubWhereInputObjectSchema.optional(), cursor: ClubWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClubScalarFieldEnumSchema, ClubScalarFieldEnumSchema.array()]).optional() }).strict();