...
export const FacultyFindManySelectSchema: z.ZodType<Prisma.FacultySelect> = z.object({
...
export const FacultyFindManySchema: z.ZodType<Prisma.FacultyFindManyArgs> = z.object({ select: FacultyFindManySelectSchema.optional(), include: z.lazy(() => FacultyIncludeObjectSchema.optional()), orderBy: z.union([FacultyOrderByWithRelationInputObjectSchema, FacultyOrderByWithRelationInputObjectSchema.array()]).optional(), where: FacultyWhereInputObjectSchema.optional(), cursor: FacultyWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FacultyScalarFieldEnumSchema, FacultyScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FacultyFindManyArgs>;
