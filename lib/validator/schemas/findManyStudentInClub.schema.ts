...
export const StudentInClubFindManySelectSchema: z.ZodType<Prisma.StudentInClubSelect> = z.object({
...
export const StudentInClubFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    clubId: z.boolean().optional(),
    studentId: z.boolean().optional(),
    roleId: z.boolean().optional(),
