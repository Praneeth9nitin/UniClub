...
export const CollegeAdminFindUniqueSchema: z.ZodType<Prisma.CollegeAdminFindUniqueArgs> = z.object({ select: CollegeAdminSelectObjectSchema.optional(), include: CollegeAdminIncludeObjectSchema.optional(), where: CollegeAdminWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.CollegeAdminFindUniqueArgs>;

export const CollegeAdminFindUniqueZodSchema = z.object({ select: CollegeAdminSelectObjectSchema.optional(), include: CollegeAdminIncludeObjectSchema.optional(), where: CollegeAdminWhereUniqueInputObjectSchema }).strict();