...
export const ClubMinOrderByAggregateInputObjectSchema: z.ZodType<Prisma.ClubMinOrderByAggregateInput> = makeSchema() as unknown as z.ZodType<Prisma.ClubMinOrderByAggregateInput>;
export const ClubMinOrderByAggregateInputObjectZodSchema = makeSchema();
