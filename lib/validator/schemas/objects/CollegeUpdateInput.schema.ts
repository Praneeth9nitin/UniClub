...
import { ClubUpdateManyWithoutCollegeNestedInputObjectSchema as ClubUpdateManyWithoutCollegeNestedInputObjectSchema } from './ClubUpdateManyWithoutCollegeNestedInput.schema';
import { CollegeAdminUpdateOneWithoutCollegeNestedInputObjectSchema as CollegeAdminUpdateOneWithoutCollegeNestedInputObjectSchema } from './CollegeAdminUpdateOneWithoutCollegeNestedInput.schema';
import { FacultyUpdateManyWithoutCollegeNestedInputObjectSchema as FacultyUpdateManyWithoutCollegeNestedInputObjectSchema } from './FacultyUpdateManyWithoutCollegeNestedInput.schema';
import { StudentUpdateManyWithoutCollegeNestedInputObjectSchema as StudentUpdateManyWithoutCollegeNestedInputObjectSchema } from './StudentUpdateManyWithoutCollegeNestedInput.schema';
import { StudentUpdateManyWithoutFollowsNestedInputObjectSchema as StudentUpdateManyWithoutFollowsNestedInputObjectSchema } from './StudentUpdateManyWithoutFollowsNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  clubs: z.lazy(() => ClubUpdateManyWithoutCollegeNestedInputObjectSchema).optional(),
  admin: z.lazy(() => CollegeAdminUpdateOneWithoutCollegeNestedInputObjectSchema).optional(),
  faculty: z.lazy(() => FacultyUpdateManyWithoutCollegeNestedInputObjectSchema).optional(),
  students: z.lazy(() => StudentUpdateManyWithoutCollegeNestedInputObjectSchema).optional(),
  followers: z.lazy(() => StudentUpdateManyWithoutFollowsNestedInputObjectSchema).optional()
}).strict();
export const CollegeUpdateInputObjectSchema: z.ZodType<Prisma.CollegeUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.CollegeUpdateInput>;
export const CollegeUpdateInputObjectZodSchema = makeSchema();
