...
import { ClubUpdateOneRequiredWithoutEventsNestedInputObjectSchema as ClubUpdateOneRequiredWithoutEventsNestedInputObjectSchema } from './ClubUpdateOneRequiredWithoutEventsNestedInput.schema';
import { RegistrationsUpdateManyWithoutEventNestedInputObjectSchema as RegistrationsUpdateManyWithoutEventNestedInputObjectSchema } from './RegistrationsUpdateManyWithoutEventNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  club: z.lazy(() => ClubUpdateOneRequiredWithoutEventsNestedInputObjectSchema).optional(),
  registrations: z.lazy(() => RegistrationsUpdateManyWithoutEventNestedInputObjectSchema).optional()
}).strict();
